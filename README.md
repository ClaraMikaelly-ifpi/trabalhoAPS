...
### 1. Casos de uso envolvidos com suas respectivas documentações;
  ...
  - [Cas.Uso-cadastrarPedido.pdf](https://github.com/user-attachments/files/18678410/Cas.Uso-cadastrarPedido.pdf)
...
### 3. Implementação das classes via código;
  - [classe via codigo_ login.pdf](https://github.com/user-attachments/files/18678020/classe.via.codigo_.login.pdf)
  - [classe via codigo_ cadastrar cliente.pdf](https://github.com/user-attachments/files/18678055/classe.via.codigo_.cadastrar.cliente.pdf)
  - [classe via codigo_ cadastrar pedido.pdf](https://github.com/user-attachments/files/18678347/classe.via.codigo_.cadastrar.pedido.pdf)
